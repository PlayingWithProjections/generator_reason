...
let alwaysWinningBot () =
  ...
  let joinGameDistribution =
    ((MonthDistribution.ForEver
        (((Steady (((OneIn ((Random.int 2)))[@explicit_arity ])))
          [@explicit_arity ])))
...
let boringPlayer () =
  let createQuizDistribution =
    ((MonthDistribution.Number
        (20, ((Steady (((PerDay (100))[@explicit_arity ])))
          [@explicit_arity ])))
      [@explicit_arity ]) |> MonthDistribution.create in
  let joinGameDistribution =
    ((MonthDistribution.Number
        ((Random.int 40),
          ((Steady (((OneIn ((Random.int 20)))[@explicit_arity ])))
          [@explicit_arity ])))
      [@explicit_arity ]) |> MonthDistribution.create in
  let openGameDistribution =
    ((MonthDistribution.Number
        ((Random.int 20),
          ((Steady (((PerMonth ((Random.int 40)))[@explicit_arity ])))
          [@explicit_arity ])))
      [@explicit_arity ]) |> MonthDistribution.create in
...
let veryGoodQuizPlayer () =
  ...
  let joinGameDistribution =
    ((MonthDistribution.ForEver
        (((Steady (((OneIn ((Random.int 10)))[@explicit_arity ])))
          [@explicit_arity ])))
      [@explicit_arity ]) |> MonthDistribution.create in
  let openGameDistribution =
    ((MonthDistribution.ForEver
